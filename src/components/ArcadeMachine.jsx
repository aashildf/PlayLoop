...
<Link
  to="/highscores"
  className="absolute block" // 'block' sørger for at den tar opp plassen sin
  style={{
    top: "26%",
    left: "50%",
    ...
    width: "22%",
    height: "21%",
    zIndex: 100, // Høyt tall så den ligger over alt annet
    perspective: "1000px",
    textDecoration: "none" // Fjerner standard link-strek
  }}
        >
